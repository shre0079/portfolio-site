      ...
      <div className="container py-10">
        <div className="flex flex-col md:flex-row gap-8 md:gap-4 justify-between">
          <div className="space-y-2">
            <h3 className="text-lg font-semibold">Shreyash Mishra</h3>
          ...
          <div>
            ...
            <ul className="mt-3 flex items-center gap-4">
              <li>
                <a
                  className="hover:text-primary transition-colors"
                  href="https://www.linkedin.com/in/smish9"
                  target="_blank"
              ...
              <li>
                <a
                  className="hover:text-primary transition-colors"
                  href="https://github.com/shre0079"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="GitHub"
                >
              ...
              <li>
                <a
                  className="hover:text-primary transition-colors"
                  href="mailto:shreyashshree0079@gmail.com"
                  aria-label="Email"
                >
                  <FaEnvelope size={20} />
                </a>
        ...
        {/* <div className="mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} shreyash Kumar. All rights reserved.
          </p>
        </div> */}
      </div>
    </footer>
