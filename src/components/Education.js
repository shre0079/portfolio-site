      ...
      <div className="container">
        ...
        <div className="space-y-4">
          <div className="rounded-md border border-border bg-card p-5 shadow-sm">
            ...
            <h4 className="text-sm text-muted-foreground">Bennett University, Greater Noida</h4>
            <p className="text-xs text-muted-foreground mt-1">August 2024 - August 2028</p>
          </div>
          <div className="rounded-md border border-border bg-card p-5 shadow-sm">
            <h3 className="text-lg font-semibold">High Schooling</h3>
            <h4 className="text-sm text-muted-foreground">Delhi Public School, Jodhpur</h4>
            <p className="text-xs text-muted-foreground mt-1">April 2019 - June 2024</p>
          </div>
        </div>
      </div>
    </section>
